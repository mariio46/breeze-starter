...
<div class="fixed inset-0 z-50 overflow-y-auto px-4 py-6 sm:px-0" style="display: {{ $show ? 'block' : 'none' }};" x-data="{
    ...
    <div class="{{ $maxWidth }} mb-6 transform overflow-hidden rounded-lg bg-card shadow-xl transition-all sm:mx-auto sm:w-full" x-show="show" x-transition:enter="ease-out duration-300"
